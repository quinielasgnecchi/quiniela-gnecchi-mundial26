...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col justify-center items-center px-4 relative overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Contenedor principal: Altura incrementada mediante py-14 manteniendo max-w-[225px] */}
      <div className="w-full max-w-[225px] px-4 py-14 rounded-[36px] bg-black border border-black relative z-10">
