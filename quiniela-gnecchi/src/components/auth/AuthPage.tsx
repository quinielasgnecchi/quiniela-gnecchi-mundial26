...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col justify-center items-center px-4 relative overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Contenedor principal: Altura incrementada un 15% (py-[128px]) manteniendo el ancho en max-w-[225px] */}
      <div className="w-full max-w-[225px] px-4 py-[128px] rounded-[36px] bg-black border border-black relative z-10">
